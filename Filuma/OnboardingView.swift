    ...
    private var welcomeStep: some View {
        VStack(spacing: 0) {
            ...
            Text("Capture in seconds")
                ...
                .padding(.bottom, 10)
            Text("Add a task with a deadline and a rough effort estimate. Filuma plans the work for you.")
    ...
    private var dayStep: some View {
        VStack(spacing: 0) {
            ...
            Text("Your day")
                ...
                .foregroundStyle(LinearGradient.hearthTitle)
                .padding(.bottom, 10)
            Text("Filuma only schedules work while you're awake. A sleep time past midnight is fine.")
                .font(AppFont.body(15))
                .foregroundStyle(Color.filumaSubtle)
                .multilineTextAlignment(.center)
                .padding(.horizontal, 40)
    ...
    private var paceStep: some View {
        VStack(spacing: 0) {
            ...
            Text("Stay on pace")
                ...
                .foregroundStyle(LinearGradient.hearthTitle)
                .padding(.bottom, 10)
            Text("Miss a block? Filuma replans it automatically. Everything you just set can be changed later in Settings.")
                .font(AppFont.body(15))
                .foregroundStyle(Color.filumaSubtle)
                .multilineTextAlignment(.center)
                .padding(.horizontal, 40)
